...
public class Swagger2Config {
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("冯仕清", "https://github.com/", "938481168@qq.com"); // 创建人、个人网站、邮箱
        return new ApiInfoBuilder().title("后台接口管理系统").description("此处介绍后台管理系统的详细情况").version("0.0.1").contact(contact).build();
    }
