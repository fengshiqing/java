...
public class DateTimeUtil {
     ...
     */
    interface FORMAT {
        String fromat_1 = "yyyy-MM-dd HH:mm:ss";
        String fromat_2 = "yyyyMMddHHmmss";
        String fromat_3 = "yyyy-MM-dd";
        String fromat_4 = "HH:mm:ss";
    }

    private static final SimpleDateFormat SDF_1 = new SimpleDateFormat(FORMAT.fromat_1);
    private static final SimpleDateFormat SDF_2 = new SimpleDateFormat(FORMAT.fromat_2);
    private static final SimpleDateFormat SDF_3 = new SimpleDateFormat(FORMAT.fromat_3);
    private static final SimpleDateFormat SDF_4 = new SimpleDateFormat(FORMAT.fromat_4);
