...
public class SortAlgorithm {
	...
	/**
	 * 原理：比较相邻的两个元素，把最大/小的元素放在最后。----Bubble sort<br>
	 * 比较相邻的元素。如果第一个比第二个大，就交换他们两个。<br>
	 * 对每一对相邻元素作同样的工作，从开始第一对到结尾的最后一对。在这一点，最后的元素应该会是最大/小的数。<br>
	 * 针对所有的元素重复以上的步骤，除了最后一个。<br>
	 * 持续每次对越来越少的元素重复上面的步骤，直到没有任何一对数字需要比较。<br>
	 * 
	 * 由于它的简洁，冒泡排序通常被用来对于程序设计入门的学生介绍算法的概念。<br>
	 */
